...
#Reference notbooks 
This repository contains Jupyter notebooks implementing the code sample's found in the book [Deep Learning with Python, 2nd Edition (Manning Publications)](https://www.manning.com/books/deep-learning-with-python-second-edition?a_aid=keras&a_bid=76564dff).
